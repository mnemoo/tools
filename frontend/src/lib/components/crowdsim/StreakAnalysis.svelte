...
<div class="rounded-2xl bg-[var(--color-graphite)]/50 border border-white/[0.03] p-5">
	<div class="flex items-center gap-3 mb-5">
		...
		<h3 class="font-mono text-base text-[var(--color-light)]">STREAK ANALYSIS</h3>
	</div>
	...
	<div class="grid grid-cols-2 gap-4">
		...
		<div class="rounded-xl bg-[var(--color-emerald)]/5 border border-[var(--color-emerald)]/10 p-4">
			<div class="flex items-center gap-2 mb-3">
				...
				<span class="text-sm font-mono text-[var(--color-emerald)]">WIN STREAKS</span>
			</div>
			<div class="space-y-3">
				<div class="flex items-center justify-between">
					<span class="text-sm font-mono text-[var(--color-mist)]">AVERAGE</span>
					<span class="text-xl font-mono font-semibold text-[var(--color-emerald)]">{stats.avg_win_streak.toFixed(1)}</span>
				</div>
				<div class="flex items-center justify-between">
					<span class="text-sm font-mono text-[var(--color-mist)]">MAXIMUM</span>
		...
		<div class="rounded-xl bg-[var(--color-coral)]/5 border border-[var(--color-coral)]/10 p-4">
			<div class="flex items-center gap-2 mb-3">
				...
				<span class="text-sm font-mono text-[var(--color-coral)]">LOSE STREAKS</span>
			</div>
			<div class="space-y-3">
				<div class="flex items-center justify-between">
					<span class="text-sm font-mono text-[var(--color-mist)]">AVERAGE</span>
	...
	<div class="mt-5 pt-4 border-t border-white/[0.03]">
		<div class="text-sm font-mono text-[var(--color-mist)] mb-3">WIN/LOSE STREAK RATIO</div>
		...
		<div class="mt-2 flex justify-between text-sm font-mono">
			<span class="text-[var(--color-emerald)]">Win: {stats.avg_win_streak.toFixed(1)}</span>
			<span class="text-[var(--color-coral)]">Lose: {stats.avg_lose_streak.toFixed(1)}</span>
		</div>
	</div>
</div>
